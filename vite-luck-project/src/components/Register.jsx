...
const Register = () => {
    ...
    // allows us to set focus on user inout when component loads as well as notify error
    ...
    const [matchFocus, setUMatchFocus] = useState(false);
        ...
        <section>
                ...
                <form onSubmit={handleSubmit}>
                    <label htmlFor="username">
                        ...
                        required
                        aria-invalid={validPdw ? "false" : "true"}
                        aria-describedby="pwdnote"
                        onFocus={() => setPwdFocus(true)}
                        onBlur={() => setPwdFocus(false)}
                        />
                        <p id="pwdnote" className={pwdFocus && !validPdw ? "instructions" : "offscreen"}>
                            <FontAwesomeIcon icon={faInfoCircle} />
                            8 to 24 characters.
